...
public class MainActivity extends AppCompatActivity {
    ...
    private void switchToViewMeetingsView() {
        ...
        filterDateInput = viewMeetingsView.findViewById(R.id.meetingDateInput);
        meetingsList = viewMeetingsView.findViewById(R.id.meetingAgendaInput);
        Button filterMeetingsButton = viewMeetingsView.findViewById(R.id.addMeetingButtonSubmit);
